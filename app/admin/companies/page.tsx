...
export default function AdminCompaniesPage() {
  ...
  const handleSubmit = async () => {
    ...
    if (res.ok) {
      ...
      setShowForm(false)
      setForm({ name: '', type: 'Product', ctc: '', minCgpa: '', date: '', branches: [], rounds: [] })
    }
    setLoading(false)
  }
      ...
      {showForm && (
        <div className="bg-gray-900 border border-gray-700 rounded-xl p-6 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="text-gray-400 text-sm mb-1 block">CTC (LPA)</label>
              <input
                className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white outline-none focus:border-blue-500"
                placeholder="e.g. 12"
                type="number"
            ...
            <div>
              <label className="text-gray-400 text-sm mb-1 block">Min CGPA</label>
              <input
                className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white outline-none focus:border-blue-500"
                placeholder="e.g. 7.0"
                type="number"
            ...
            <div className="col-span-2">
              <label className="text-gray-400 text-sm mb-1 block">Drive Date</label>
              <input
                className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white outline-none focus:border-blue-500"
                type="date"
                value={form.date}
            ...
            <div>
              <label className="text-gray-400 text-sm mb-2 block">Eligible Branches</label>
            ...
            <div>
              <label className="text-gray-400 text-sm mb-2 block">Interview Rounds</label>
              <div className="flex gap-2 flex-wrap">
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-800">
              <th className="text-left text-gray-400 text-sm font-medium p-4">Company</th>
              <th className="text-left text-gray-400 text-sm font-medium p-4">Type</th>
              <th className="text-left text-gray-400 text-sm font-medium p-4">CTC</th>
              <th className="text-left text-gray-400 text-sm font-medium p-4">Min CGPA</th>
          ...
          <tbody>
            {companies.map((company: any) => (
              <tr key={company.id} className="border-b border-gray-800 hover:bg-gray-800">
                ...
                <td className="p-4 text-green-400 text-sm">₹{company.ctc} LPA</td>
